...
const Header = () => {
  return (
    <div className="grid grid-cols-12 px-6 py-1 gap-6 ">
      ...
      <i className="fa-solid fa-bars text-xl hover:cursor-pointer"></i>
       <img className="w-28 hover:cursor-pointer" alt="Youtube logo" src={LOGO} />
      </div>

      <div className="col-span-6 flex gap-2  p-3">
       <div className="flex w-full">
        <input className="w-full border border-light-gray p-3 text-sm rounded-l-full"
      ...
      <div className="col-span-3 flex items-center  gap-6 justify-end ">
        <button className="flex items-center text-sm gap-2 bg-gray-100 px-4 py-2 rounded-full hover:cursor-pointer">
